...
enum target_names {theta_s, Omega_dm_tot, Omega_dcdmdr, omega_dcdmdr, Omega_scf, Omega_ini_dcdm, omega_ini_dcdm, omega_ini_dcdm_hat, f_dm_decay, sigma8, T_cmb_dcdmsr};
